...
class UnlimitedPartsSource(object):
    ...
    def _add_prototypes(self):
        ...
        self.part_list.append(gears.base.HighOutputEngine(size=1000,scale=gears.scale.MechaScale))
        self.part_list.append(gears.base.HighPerformanceEngine(size=1000,scale=gears.scale.MechaScale))
        self.part_list.append(gears.base.Gyroscope(scale=gears.scale.MechaScale))
        self.part_list.append(gears.base.AdvancedGyroscope(scale=gears.scale.MechaScale))
        self.part_list.append(gears.base.Cockpit(scale=gears.scale.MechaScale))
        self.part_list.append(gears.base.DMCCockpit(scale=gears.scale.MechaScale))
        self.part_list.append(gears.base.ReflexCockpit(scale=gears.scale.MechaScale))
