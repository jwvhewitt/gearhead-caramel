...
def play_the_game():
    ...
    #mypic = pbge.image.Image('RanMagnus.png',color=list((gears.color.GriffinGreen, gears.color.DarkSkin, gears.color.Fuschia, gears.color.PlasmaBlue, gears.color.CardinalRed)))
    #mydest = pygame.Surface((mypic.frame_width, mypic.frame_height))
    #mydest.fill((0, 0, 255))
    #mypic.render((0,0),dest_surface=mydest)
    #pygame.image.save(mydest, pbge.util.user_dir("out_RanMagnus.png"))
